...
import { useGetProvinsiQuery } from '@/store/slices/pendaftaranAPI'
...
export function FormListProvinsi({
  name,
  headerLabel,
  placeholder,
  isDisabled,
  ...
  const [listProvinsi, setListProvinsi] = useState<ProvinsiType[]>([])
  const { data, isSuccess, isLoading, isFetching } = useGetProvinsiQuery()

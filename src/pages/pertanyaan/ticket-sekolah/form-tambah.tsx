...
import { FormListPendaftar } from '@/components/form/formListPendaftar'
import { FormLabelInput, Input } from '@/components/input'
import Tiptap from '@/components/tiptap'
import { TiketSekolahType } from '@/libs/types/tiket-type'
import { useCreateFileMutation } from '@/store/slices/pertanyaanAPI'
...
export function FormTiket({
  ...
  useEffect(() => {
    if (isEdit) {
      ...
      form.setValue('idMasalah', data?.id_masalah)
      form.setValue('idPendaftaran', data?.id_pendaftaran)
